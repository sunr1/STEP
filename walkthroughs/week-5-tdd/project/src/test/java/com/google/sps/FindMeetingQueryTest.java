...
public final class FindMeetingQueryTest {
  ...
  private static final String PERSON_C_OPTIONAL = "Person C";
  ...
  public void optionalAttendeeHasAllDayEvent() {
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 3",
            ...
            Arrays.asList(PERSON_C_OPTIONAL)));

    MeetingRequest request =
        new MeetingRequest(Arrays.asList(PERSON_A, PERSON_B), DURATION_30_MINUTES);
    request.addOptionalAttendee(PERSON_C_OPTIONAL);
  ...
  @Test
  public void optionalAttendeeHasEventAvailability() {
    // An optional attendee has an event in the morning where they are able to attend the event in
    // accordance with the mandatory people's time slots. Return early and late parts of the day.
    //
    // Events  :       |--A--||-C-||--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|                 |--3--|
  ...
  public void justEnoughRoomWithOptionalAttendee() {
    // An optional attendee has a 15 minute meeting. Return results according to the mandatory
    // person's availability since the optional person's free time slot is not enough for the
    // requested time.
    //
    // Events  : |--A--||-B-||----A----|
    // Day     : |---------------------|
  ...
  public void optionalAttendeesWithGaps() {
    // Two optional attendees with several gaps in their schedules. Return their free time slots.
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  public void optionalAttendeesWithNoGaps() {
    // Two optional attendees with no gaps in their schedules. Return no free time slots.
    //
    // Events  : |----A----||-----B----|
    // Day     : |---------------------|
    // Options :
